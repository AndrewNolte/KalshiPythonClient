...
# **login_mfa**
> LoginResponse login_mfa()

LoginMfa

End-point to start a rest session with Kalshi, when you have 2FA enabled.  Before calling this end-point you should call (POST /log_in) using email and password.
