    ...
    def __init__(self, api_client=None):
        ...
        def __login_mfa(
            ...
            **kwargs
            ...
            End-point to start a rest session with Kalshi, when you have 2FA enabled.  Before calling this end-point you should call (POST /log_in) using email and password.  # noqa: E501
            This method makes a synchronous HTTP request by default. To make an
            asynchronous HTTP request, please pass async_req=True

            >>> thread = api.login_mfa(async_req=True)
            >>> result = thread.get()


            Keyword Args:
                log_in_mfa_request (LogInMfaRequest): Login input data. [optional]
                _return_http_data_only (bool): response data without head status
                    code and headers. Default is True.
                _preload_content (bool): if False, the urllib3.HTTPResponse object
                    will be returned without reading/decoding response data.
        ...
        self.login_mfa = _Endpoint(
            settings={
                'response_type': (LoginResponse,),
                'auth': [],
                'endpoint_path': '/log_in_mfa',
                'operation_id': 'login_mfa',
                'http_method': 'POST',
                'servers': None,
            },
            params_map={
