...
class LogInMfaRequest(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, code, email, *args, **kwargs):  # noqa: E501
        """LogInMfaRequest - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, code, email, *args, **kwargs):  # noqa: E501
        """LogInMfaRequest - a model defined in OpenAPI
