...
class CreateUserRequest(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, area_code, country_code, email, password, phone_number, *args, **kwargs):  # noqa: E501
    ...
    @convert_js_args_to_python_args
    def __init__(self, area_code, country_code, email, password, phone_number, *args, **kwargs):  # noqa: E501
        """CreateUserRequest - a model defined in OpenAPI
